-- Publish native observer slots explicitly in multiplayer activity.
-- Legacy launchers omit `observer`; a true observer has no kingdom-derived
-- team, color, race, or subrace and can never be a bot.
