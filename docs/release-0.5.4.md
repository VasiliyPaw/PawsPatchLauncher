# Paw's Patch Launcher 0.5.4

## Русский

- Новая сине-золотая иконка Paw's Patch с буквой P — для EXE, панели задач и окна. Встроены девять размеров от 16 до 256 пикселей; внутри лаунчера используется тот же векторный знак.
- Arial во всём интерфейсе, включая заголовки, историю изменений, настройки и код конфигурации.
...
- New blue-and-gold Paw's Patch P icon for the executable, taskbar and window. Nine sizes from 16 to 256 pixels are embedded; the app uses the same vector mark.
- Arial throughout the interface, including headings, changelogs, settings and configuration codes.
