# Paw's Patch 0.1.0-beta.7

- Случайный тип карты: один из четырёх типов, общие сохраняемые настройки и стандартные значения особой местности.
- Случайное время суток с сохранением выбора после перезапуска.
- Исправлена найденная причина стартового рассинхрона после повторных матчей или аварийного выхода.
- Хост меняет цвета всех участников, клиент только свой. Цвета сохраняются после возврата в лобби и повторного подключения.
- Если прежний цвет вернувшегося игрока уже занят, он получает «Случайно».
- В лобби сохранения показаны цвета королевств из сейва без возможности изменения. При перестановке игроков цвет остаётся у королевства.
