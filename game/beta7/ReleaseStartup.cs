...
internal static class ReleaseStartup
{
    ...
    internal const string Build = "beta.0.3.0-beta.8-test.6-1372-city-policy20-transfer-r2-lobby1-quiet";
#elif FAST_SAVE_TRANSFER
    internal const string Build = "beta.0.3.0-beta.4-1372-city-policy20-transfer-r2-quiet";
#else
