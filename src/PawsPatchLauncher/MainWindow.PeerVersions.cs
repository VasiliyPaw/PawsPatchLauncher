...
public partial class MainWindow
{
    ...
    private string FriendVersionWarning(PeerVersionStatus status) => status switch
    {
        ...
        PeerVersionStatus.Unknown => T("Сведения о версиях игрока пока недоступны. Копирование станет доступно после их получения и проверки.", "The player's version information is not available yet. Copying will be available after it is received and checked."),
