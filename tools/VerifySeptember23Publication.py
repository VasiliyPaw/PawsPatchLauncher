"""Read back beta.2 release bytes and signed catalogs; no publication writes."""
...
if a.catalog:
    ...
    for channel,path in FEEDS.items():
        ...
        if channel=='beta':assert feed['patchGuide']['version']=='0.4.0-beta.2'
    ...
    tag='patch-0.4.0-beta.2';release=get('/releases/tags/'+tag)
